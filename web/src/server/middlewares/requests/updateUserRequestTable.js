const updateUserRequestTable = async (login) => {
  ...
  try {
    ...
    console.log('UPDATE_USER_REQUEST_TABLE_ERROR:::',err)
    return {status: 'error',place : 'UPDATE_USER_REQUEST_TABLE'};
  }

}
  
module.exports = updateUserRequestTable;
